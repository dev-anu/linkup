    ...
    <ScreenWrapper>
        ...
        <View style={styles.container}>
            ...
            <View style={styles.form}>
                <Text style={{fontSize:hp(2),color:theme.colors.text}}>Please fill the details to create an account</Text>
                <Input icon={<FontAwesome5 name="user" size={24} color="gray" />}
